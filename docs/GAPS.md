...
- **African country scope:** The local `tuxundoc/index.html` has 18 African country/territory chapters, not all African sovereign states. The earlier source-only policy prevents inventing facts or pretending other countries are complete. Additional source chapters are needed for that broader goal.
