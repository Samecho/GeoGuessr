...
export type Asset = {
  ...
  attribution: string; redistribution: string; reviewed: string; status: 'source-reference'; sourcePath?: string; cardCrop?: 'left' | 'top' | 'bottom' | 'left-half' | 'right-half' | 'top-half' | 'bottom-half'
}
export type Clue = {
  ...
  referenceAssetIds?: string[]; exclusionAllowed?: boolean; cardCrop?: 'left' | 'top' | 'bottom' | 'left-half' | 'right-half' | 'top-half' | 'bottom-half'
}
